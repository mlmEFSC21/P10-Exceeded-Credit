...
customer.beginBalance = parseInt(
    prompt("Enter the beginning account balance.")
);
...
let customer.newBalance = customer.beginBalance + monthlyCharges - monthlyCredits;
if (customer.newBalance > customer.creditLimit) {return "Credit limit exceeded"};
